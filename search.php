...
<h1>Please Enter Search keyword</h1>
<form action="ticket_search.php" method="get" name="form1" class="formText" onSubmit="MM_validateForm('fname','','R','lname','','R','address','','R','city','','R','state','','R','zip','','RisNum','email','','RisEmail','phone','','RisNum');return document.MM_returnValue">
  <table width="59%" border="0" cellspacing="0" cellpadding="5">
  <tr> 
      <td width="28%"><font size="4">Search Key</font></td>
      <td width="72%"><input name="keyword" type="text" id="keyword" value="<?php echo $title;?>" size="20" maxlength="20"></td>
    </tr>
...
<p><a class="smallbutton" href="home.php">Return </a></p>
</body>
</html>
